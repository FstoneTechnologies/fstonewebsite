  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        'template_1fl96mo',       //  emailj Template ID
        {
          name: formData.name,
        ...
        'qNlskmNIBJ1KqrjBT'         // emailjs Public Key
      )
      .then(() => {
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-stretch">
          ...
          {/* RIGHT COLUMN – FORM */}
          <div className="bg-[#0B8FA6] rounded-2xl p-8 border border-[#0B8FA6] shadow-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                ...
                iconPosition="right"
                disabled={loading}
                className="bg-[#1F74B5] hover:bg-accent text-white"
              >
