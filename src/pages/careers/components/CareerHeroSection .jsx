      ...
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 min-h-[90vh]">
        ...
        <div className="flex flex-col justify-center px-8 lg:px-20 py-16 space-y-8 z-10 mt-10 lg:mt-15">
          <h1 className="text-4xl lg:text-6xl font-bold text-slate-900 leading-tight">
            ...
            <span className="text-accent">Grow With Fstone.</span>
          </h1>

          <p className="text-lg text-slate-700 max-w-xl">
            At Fstone Technologies, we believe great careers are built with
            purpose, innovation, and collaboration. Join a team where your
            ideas matter and your growth is supported.
          </p>
        ...
        <div className="relative hidden lg:block">
          ...
          >
            <Image
              src="/careerHero.jpg"
              alt="Careers at Fstone Technologies"
