...
//     logo: 'https://upload.wikimedia.org/wikipedia/commons/3/3b/DTCC_Logo.svg',
//     count: 'Global Partner'
//   },
//   {
//     name: 'TATA',
//     description: 'Enterprise and technology transformation partner',
//     logo: 'https://upload.wikimedia.org/wikipedia/commons/4/4c/Tata_logo.svg',
...
//                 <div className="bg-card border border-border rounded-2xl p-6 hover:shadow-brand transition-all duration-300 group-hover:scale-105">
//                   <div className={`w-12 h-12 mx-auto mb-4 rounded-xl bg-surface flex items-center justify-center ${metric?.color}`}>
...
//                   Decades of Workforce Leadership
//                 </h4>
//                 <p className="text-foreground/80 mb-6 leading-relaxed">
//                   Our founder brings over 25 years of experience in building, scaling, and managing high-performing
//                   teams across industries. This deep understanding of talent, operations, and delivery enables
//                   organisations to grow efficiently while maintaining quality and compliance.
//                 </p>
//                 <div className="space-y-3">
//                   <div className="flex items-center space-x-3">
//                     <Icon name="Check" size={16} className="text-success" />
//                     <span className="text-sm text-foreground">Staffing & Talent Strategy</span>
//                   </div>
//                   <div className="flex items-center space-x-3">
//                     <Icon name="Check" size={16} className="text-success" />
//                     <span className="text-sm text-foreground">Enterprise Delivery & Operations</span>
//                   </div>
//                   <div className="flex items-center space-x-3">
//                     <Icon name="Check" size={16} className="text-success" />
//                     <span className="text-sm text-foreground">Leadership & Workforce Consulting</span>
//                   </div>
//                 </div>
//               </div>
//               <div className="relative">
//                 <div className="bg-card rounded-2xl p-6 shadow-brand">
//                   <div className="text-center mb-4">
//                     <div className="text-3xl font-bold text-primary mb-2">1998</div>
//                     <div className="text-sm text-muted-foreground">Professional Career Started</div>
//                   </div>
//                   <div className="space-y-4">
//                     <div className="flex justify-between items-center">
//                       <span className="text-sm text-foreground">Clients Served</span>
...
//                     </div>
//                     <div className="flex justify-between items-center">
//                       <span className="text-sm text-foreground">Enterprise Partnerships</span>
...
//                 <div key={index} className="bg-card border border-border rounded-xl p-6 text-center hover:shadow-brand transition-all duration-300">
...
//                   <p className="text-sm text-muted-foreground mb-2">{cert?.authority}</p>
...
//                 <div key={index} className="text-center group">
//                   <div className="w-20 h-20 mx-auto mb-4 rounded-xl overflow-hidden shadow-lg group-hover:shadow-xl transition-all duration-300">
//                     <Image
//                       src={partner.logo}
//                       alt={partner.name}
