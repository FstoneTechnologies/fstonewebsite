  ...
  return (
    <>
      ...
      >
        ...
        {/* Buttons */}
        <div className="flex flex-col sm:flex-row gap-2 mt-6 text-sm">
          <button
            onClick={handleAccept}
            className="flex-1 bg-[#1F74B5] hover:bg-yellow-600 text-white font-medium py-2 rounded-full"
          >
            Accept
          </button>
          <button
            onClick={handleDeny}
            className="flex-1 border py-2 rounded-full hover:bg-gray-100"
          >
            Deny
          </button>
          <button
        ...
        {/* Footer */}
        <div className="text-xs text-center mt-4 flex justify-center gap-2 flex-wrap">
          <a href="/cookie-policy" className="text-orange-600 underline">
            Cookie Policy
          </a>
          |
